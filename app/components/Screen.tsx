...
function ScreenWithoutScrolling(props: ScreenProps) {
  ...
  return (
    <View style={[$outerStyle, {paddingHorizontal: spacing.md,height:SCREEN_HEIGHT()},style]}>
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={[
        ...
        contentContainerStyle,
        {paddingHorizontal: spacing.md,height:SCREEN_HEIGHT()},
        style,
      ]}
    >
      {children}
    ...
    <View style={[$containerStyle, { backgroundColor }, $containerInsets]}>
      ...
      >
        {isNonScrolling(props.preset) ? (
          <ScreenWithoutScrolling {...props} style={style}/>
        ) : (
          <ScreenWithScrolling {...props} style={style}/>
        )}
      </KeyboardAvoidingView>
    </View>
  )
